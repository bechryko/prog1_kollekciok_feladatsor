...
public class HalmazOsztalyozas {
    ...
    ha egy o1 és o2 objektumra o1.equals(o2) igaz, és o1.hashCode() == o2.hashCode() is igaz, akkor fogja a Map azonos kulcsnak érzékelni őket
    éppen ezért az equals és hashCode metódusokat kell megfelelően megvalósítani */

    // a legegyszerűbb megoldás ekkor, ha azt mondjuk, hogy akkor legyen két ilyen halmazosztályozás egyenlő, ha egyenlők a hash kódjaik
    @Override
    ...
    public int hashCode() {
        ...
        for(int i: halmaz) szorzat *= (int)Math.signum(i);
        return szorzat;
        ...
        a legbiztosabb, ha csak az előjelekkel szorzunk, az eredmény így is helyes lesz, és így a szorzat változó csak a -1, 0, 1 értékeket veheti fel */
    }
}
